...
from actions.git_nodes import create_pr, handle_failure
...
def build_graph():
    ...
    Workflow: load_project_context (incl. issue fetch) → code → generate_tests → test → (conditional routing)
    ...
    workflow.add_conditional_edges(
        ...
        route_after_context,
        {"code": "code", "fail_state": "fail_state"},
    )
